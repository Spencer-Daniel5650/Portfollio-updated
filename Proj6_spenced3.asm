TITLE Project 6 - String Primitivess   (Proj6_spenced3.asm)

; Author: Daniel Spencer
; Last Modified: 03/17/2024
; OSU email address: spenced3@oregonstate.edu
...
programTitle		BYTE	"Project 6 - String Primitives", 13, 10, 0
programByline		BYTE	"By Daniel Spencer", 13, 10, 13, 10, 0
...
instructions		BYTE	"Hello. This program takes 10 signed integers.", 13, 10
...
; Output Identifiers
outputNumbers		BYTE	"These are the numbers you entered:", 13, 10, 0
...
; Goodbye Identifiers
goodbye				BYTE	"Thank you for using the program!", 13, 10, 0
